...
const { createEnrollmentRequest, acceptEnrollmentRequest ,getEnrollmentRequestsByCourse,rejectEnrollmentRequest,getEnrollmentRequestsByStudent } = require('../Controllers/enrollmentRequestController.js');
...
router.get('/student/:studentId', getEnrollmentRequestsByStudent);
